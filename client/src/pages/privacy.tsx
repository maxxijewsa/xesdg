  ...
  const sections = [
    {
      ...
      content:
        "Kyre collects Discord User ID, username, avatar, Server (Guild) ID, name, settings, message content for moderation (temporarily), moderation logs and actions, user levels and XP data, and ticket conversations and transcripts.",
    },
    {
      number: "2",
    ...
    },
    {
      ...
      title: "Data Sharing",
      content:
        "We do not sell, trade, or share your data with third parties. Your data is only used within the Kyre bot to provide its services to your Discord server.",
    },
    {
      number: "5",
      title: "Data Retention",
      content:
        "We retain data as long as the bot is active in your server. When you remove Kyre from your server, you can request complete data deletion by contacting us on our Discord server.",
    },
    {
      number: "6",
      title: "Your Rights",
      ...
      <section className="py-16 md:py-24 border-b bg-gradient-to-br from-primary/10 via-chart-2/10 to-background">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-2">
            Your privacy is important to us. Learn how Kyre protects and manages your data.
          </p>
